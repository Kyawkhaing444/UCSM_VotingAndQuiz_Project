                                ...
                                <div class="card-body">
                                    <!-- Default unchecked -->
                                        ...
                                        <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="defaultGroupExample1" name="{{ $q->item1 }}">
                                                <label class="custom-control-label" for="defaultGroupExample1">{{ $q->item1 }}</label>
                                            </div>

                                            <!-- Group of default radios - option 2 -->
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="defaultGroupExample2" name="{{ $q->item1 }}">
                                                <label class="custom-control-label" for="defaultGroupExample2">{{ $q->item2 }}</label>
                                            </div>

                                            <!-- Group of default radios - option 3 -->
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" id="defaultGroupExample3" name="{{ $q->item1 }}">
                                                <label class="custom-control-label" for="defaultGroupExample3">{{ $q->item3 }}</label>
                                            </div>
                                             <!-- Group of default radios - option 3 -->
                                            <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" id="defaultGroupExample4" name="{{ $q->item1 }}">
